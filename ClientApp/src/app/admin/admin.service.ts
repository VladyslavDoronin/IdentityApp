...
import { MemeberAddEdit } from '../shared/models/admin/memberAddEdit';
...
export class AdminService {
  ...
  getMember(id: string){
    return this.http.get<MemeberAddEdit>(`${environment.appUrl}/api/admin/get-member/${id}`);
  }
  ...
  addEditMemeber(model: MemeberAddEdit){
