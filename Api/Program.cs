...
//adding UseAuthentification into our pipline and this should come before UseAuthorization
...
catch(Exception ex)
{
    ...
    logger.LogError(ex.Message, "Failed to initialize an seed the database");
}
#endregion
